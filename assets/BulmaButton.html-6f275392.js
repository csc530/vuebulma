...
const _hoisted_25 = /* @__PURE__ */ createBaseVNode("code", null, "BulmaSize", -1);
...
const _hoisted_51 = /* @__PURE__ */ createStaticVNode('<h3 id="isstatic" tabindex="-1"><a class="header-anchor" href="#isstatic" aria-hidden="true">#</a> isStatic</h3><p>Type: <code>boolean</code> | <code>undefined</code></p><p>When true, the button will look non-interactive</p><h3 id="isactive" tabindex="-1"><a class="header-anchor" href="#isactive" aria-hidden="true">#</a> isActive</h3><p>Type: <code>boolean</code> | <code>undefined</code></p><p>When true, the button will look active, as if it&#39;s currently being clicked</p><h2 id="exposes" tabindex="-1"><a class="header-anchor" href="#exposes" aria-hidden="true">#</a> Exposes</h2><h3 id="isselected" tabindex="-1"><a class="header-anchor" href="#isselected" aria-hidden="true">#</a> isSelected</h3><p>Type: <code>boolean</code></p><p>Controls the <code>is-selected</code> class which will increase the button&#39;s z-index</p>', 10);
