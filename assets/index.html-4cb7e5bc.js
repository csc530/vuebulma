...
const _hoisted_2 = /* @__PURE__ */ createBaseVNode("p", null, "The types and helper functions found throughout are used to simplify development and types used by components. Many of the types and functions are exported for use and are recommended to use in conjunction with the components especially if building with Typescript.", -1);
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("code", null, "tag", -1);
const _hoisted_4 = {
  href: "https://developer.mozilla.org/en-US/docs/Glossary/semantics#semantics_in_html",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("em", null, "non-semantic", -1);
const _hoisted_6 = /* @__PURE__ */ createBaseVNode("code", null, "div", -1);
