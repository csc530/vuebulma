...
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("h1", {
  ...
  /* @__PURE__ */ createTextVNode(" BulmaBlock")
], -1);
const _hoisted_2 = {
...
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("a", { href: "../../src/components/containers/BulmaBlock.vue" }, "Component source", -1);
const _hoisted_4 = /* @__PURE__ */ createStaticVNode('<p>A container to consistently space content.</p><h2 id="slots" tabindex="-1"><a class="header-anchor" href="#slots" aria-hidden="true">#</a> Slots</h2><h3 id="default" tabindex="-1"><a class="header-anchor" href="#default" aria-hidden="true">#</a> default</h3><p>Content to display in the block.</p><h2 id="props" tabindex="-1"><a class="header-anchor" href="#props" aria-hidden="true">#</a> Props</h2>', 5);
const _hoisted_9 = {
  id: "tag",
  tabindex: "-1"
};
...
const BulmaBlock_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "BulmaBlock.html.vue"]]);
export {
  BulmaBlock_html as default
};
