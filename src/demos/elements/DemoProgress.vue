<template>
	...
	<bulma-box>
		...
		<fieldset
			...
			<bulma-form-field is-horizontal label="Value">
				<bulma-input v-model="val" type="number" />
			</bulma-form-field>

			<bulma-form-field is-horizontal label="Max value">
				<bulma-input v-model="max" type="number" />
			</bulma-form-field>
